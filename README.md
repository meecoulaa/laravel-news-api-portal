...
```
cd existing_repo
git remote add origin https://git.barrage.net/forge/barrage-forge-5/toni-mijic/forge-task-1-laravel-news-portal.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.barrage.net/forge/barrage-forge-5/toni-mijic/forge-task-1-laravel-news-portal/-/settings/integrations)
